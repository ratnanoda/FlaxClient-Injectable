 ...
 * eight directions that can be produced by vanilla WASD controls.
 */
public final class MoveFixUtils {
	...
	/**
	 * Returns true when the supplied forward/strafe ratio is already one of the
	 * vanilla cardinal or diagonal directions. The absolute input strength is
	 * ignored so sneak slowdown and future module speed scaling are preserved.
	 */
	...
	/**
	 * Applies Minecraft 1.8's moveFlying calculation with the supplied input
	 * snapped to the vanilla eight-direction grid. This is used only when the
	 * original vector is outside that grid; normal keyboard movement continues
	 * through Minecraft's original method untouched.
	 */
