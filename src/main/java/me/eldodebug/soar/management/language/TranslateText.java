...
public enum TranslateText {
	...
	HOME("text.home"), MODULE("text.module"), COSMETICS("text.cosmetics"), MUSIC("text.music"), YOUTUBE("text.youtube"),
	YOUTUBE_PIP("text.youtubepip.name"), YOUTUBE_PIP_DESCRIPTION("text.youtubepip.description"),
	QUALITY("text.quality"), QUALITY_360P("text.quality.360p"), QUALITY_480P("text.quality.480p"), QUALITY_720P("text.quality.720p"), SCREENSHOT("text.screenshot"),
	...
	AMOUNT("text.amount"), TYPE("text.type"), ACCUM("text.accum"), SHADER("text.shader"),
	SHADER_DESCRIPTION("text.shader.description"), FOG_COLOR("text.fogcolor"), OBJECT_COLOR("text.objectcolor"),
	DENSITY("text.density"), OBJECT_OPACITY("text.objectopacity"), OBJECT_FILL("text.objectfill"),
	FOG_DISTANCE("text.fogdistance"), FOG_DENSITY("text.fogdensity"), AMBIENT_FOG("text.ambientfog"),
	...
	FREELOOK_DESCRIPTION("text.freelook.description"), GHOST_FREELOOK("text.ghostfreelook.name"), GHOST_FREELOOK_DESCRIPTION("text.ghostfreelook.description"), INVERT_YAW("text.invertyaw"), INVERT_PITCH("text.invertpitch"), TOGGLE("text.toggle"),
	...
	REQUIRED_FILE_MISSING("text.requiredfilemissing"), GODBRIDGE_ASSIST("text.godbridgeassist.name"), GODBRIDGE_ASSIST_DESCRIPTION("text.godbridgeassist.description"), ENTITY_CULLING("text.entityculling.name"), ENTITY_CULLING_DESCRIPTIONN("text.entityculling.description"), TEXT("text.text"),
		...
		HEALTH_BAR("text.healthbar.name"), HEALTH_BAR_DESCRIPTION("text.healthbar.description"), SIDE_OFFSET("text.sideoffset"), MIN_CPS("text.mincps"), MAX_CPS("text.maxcps"),
