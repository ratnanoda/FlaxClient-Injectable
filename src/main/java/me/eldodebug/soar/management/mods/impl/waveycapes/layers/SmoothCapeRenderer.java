...
import me.eldodebug.soar.utils.vector.Matrix4f;
import me.eldodebug.soar.utils.vector.PoseStack;
import me.eldodebug.soar.utils.vector.Vector3f;
import me.eldodebug.soar.utils.vector.Vector4f;
...
public class SmoothCapeRenderer {
    ...
    public void modifyPoseStack(CustomCapeRenderLayer layer, PoseStack poseStack, AbstractClientPlayer abstractClientPlayer, float h, int part) {
